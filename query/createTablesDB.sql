rename table estudandes TO estudantes; # renomear tabela
...
insert into estudandes(nome, data_nascimento, email, cpf, telefone, sistema_gestao_escolar.estudandes.endereco)
values ('Rafael Grando', '1996-06-21', 'rafael@email.com', 12345678910, '12345678910', 'Rua xpto numero 123');

select * from estudandes; # mostra os dados inseridos na tabela
...
values
('T001', '2023-01-10', '2023-03-10', 'MATUTINO', 1),
...
values
('Ana Silva', '1990-01-01', 'ana.silva@email.com', '12345678901', '12345678901', 'Rua A, 123'),
